...
exports.healthCheck = exports.approveAnomaly = exports.processTelemetry = void 0;
...
const fieldValue = firestore_1.FieldValue;
// ============================================================================
// CONFIGURATION
// ============================================================================
const CONFIG = {
 ...
 */
function calculateSurprise(observed, baseline, variance) {
    const surprises = [];
 ...
 */
function determineAnomalyType(metrics) {
    ...
    if (metrics.database?.poolUtilization >= 0.8)
 ...
 */
function determineSeverity(surpriseScore) {
    if (surpriseScore >= CONFIG.criticalThreshold)
        return 'critical';
 ...
 */
function suggestRemediation(type) {
    const actions = {
 ...
 */
async function sendDiscordNotification(anomaly) {
 ...
 */
async function triggerActuator(anomalyId, action) {
    try {
...
exports.processTelemetry = functions.firestore
    ...
    try {
        ...
        if (model && model.isReady) {
            ...
            surpriseScore = calculateSurprise(observed, model.baseline, model.variance);
        }
 ...
 */
exports.approveAnomaly = functions.https.onCall(async (data, context) => {
